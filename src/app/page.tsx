...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    region !== "default"
      ? `Купите красивый VIP номер телефона с доставкой в ${city}. Большой выбор эксклюзивных номеров от МТС, Билайн, Мегафон, Теле2. Быстрая доставка и лучшие цены.`
      : `Купите красивый VIP номер телефона с доставкой по России. Большой выбор эксклюзивных номеров от МТС, Билайн, Мегафон, Теле2. Быстрая доставка и лучшие цены.`;
  ...
  return {
    ...
    keywords:
      region !== "default"
        ? `красивые номера, купить номер телефона, доставка номеров, vip номера, ${city}`
        : `красивые номера, купить номер телефона, доставка номеров, vip номера`,
    openGraph: {
      title,
      description,
      url: siteUrl,
